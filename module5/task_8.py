...
apartment_price = int(input('Введите сумму квартиры: '))
apartment_area = int(input('Введите площаль квартиры: '))

if (apartment_area >= 100 and apartment_price <= 10) or (apartment_area >= 80 and apartment_price <= 7):
