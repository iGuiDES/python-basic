...
earnings = int(input('Введите свой доход: '))

if earnings < 10000:
  tax = earnings * 0.13
elif 10000 >= earnings < 50000:
  tax = 10000 * 0.13 + (earnings - 10000) * 0.2
else:
  tax = 10000 * 0.13 + 40000 * 0.2 + (earnings - 50000) * 0.3
print('Cумма налога:', tax)
