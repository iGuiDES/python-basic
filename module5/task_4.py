...
aplicant_position = int(input('Введите место в списке поступающих: '))
aplicant_points = int(input('Введите количество баллов за экзамены: '))

if (aplicant_position >= 1 and aplicant_position <= 10):
  print('Поздравляем, Вы поступили!') 
  if (aplicant_points >= 290):
    print('Бонусом Вам будет начисляться стипендия')
  elif aplicant_points < 290:
    print('Но Вам не хватало баллов для стипендии')
else:
