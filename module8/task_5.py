...
first_point = int(input('Введите начало отрезка: '))
end_point = int(input('Введите конец отрезка: '))
step = int(input('Введите шаг: '))
sum_func = 0

for point in range(end_point, first_point - 1, -1):
    sum_func = point ** 3 + 2 * point ** 2 - 4 * point + 1
    print('В точке', point, 'функция равна', sum_func)
