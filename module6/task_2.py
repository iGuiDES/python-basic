...
questions_collector = int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))

debt = 100
while questions_collector < debt:
  print('Маловато, Василий. Давайте ещё раз.')
  int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))
  debt -= questions_collector
