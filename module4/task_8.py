...
hours_works = int(input('Введите отработанные часы: '))
credit_remainder = int(input('Введите остаток по кредиту: '))
for_food = int(input('Введите траты на еду: '))

wage = 200 * hours_works / 2 ** 3 + hours_works
cost_amount = credit_remainder + for_food

if wage >= cost_amount:
  print('Часов хватает. Можно отдохнуть!')
else:
  print('Часов не хвататет. Придется работать!')
