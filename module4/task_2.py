...
first_question = int(input('Введите количество баллов по русскому языку: '))
second_question = int(input('Введите количество баллов по математике: '))
third_question = int(input('Введите количество баллов по информатике: '))

sum_answer_user = first_question + second_question + third_question

if sum_answer_user >= 270:
